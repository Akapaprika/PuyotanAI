...
class StatusBarWidget(QWidget):
    ...
    def __init__(self, initial_interval_ms: int = 100, initial_seed: int = 1, parent=None):
        ...
        self._status_label.setStyleSheet("font-size: 10pt; color: #94a3b8; font-weight: bold;")
        ...
        self._seed_spin.setStyleSheet("font-size: 9pt;")
        ...
        self._interval_spin.setStyleSheet("font-size: 9pt;")
